...
import static net.eggsaregood.duckymod.sound.ModSounds.DUCKY_BLOCK_BREAK;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> DUCKY_BLOCK = registerBlock("ducky_block",
